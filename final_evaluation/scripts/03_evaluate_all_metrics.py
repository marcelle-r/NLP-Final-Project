...
UPDATED FOR ABLATION STUDY MODELS
"""
...
# Models to evaluate - UPDATED
MODELS = ["safe_lora_1k", "safe_lora_5k", "safe_lora_10k", "safe_lora_full"]
...
def main():
    print("="*70)
    print("EVALUATING ABLATION STUDY MODELS")
    print("="*70)
